...
# Script to restart a single tunnel without triggering full restart
# Usage: restart_single_tunnel.sh <remote_host> <remote_port> <local_port> <direction>
...
# When run as myuser, SSH will automatically use /home/myuser/.ssh/config

...
- [`scripts/control_api.sh`](../../scripts/control_api.sh) - Cleanup during API restart
- [`scripts/start_autossh.sh`](../../scripts/start_autossh.sh) - Cleanup during container startup
...
Added two new functions in [`scripts/tunnel_utils.sh`](../../scripts/tunnel_utils.sh):
